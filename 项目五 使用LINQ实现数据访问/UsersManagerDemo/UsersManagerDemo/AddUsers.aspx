<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUsers.aspx.cs" Inherits="UsersManagerDemo.AddUsers" Theme="Default" %>
...
<div>    
        ...
        <table class="tb_content">
            ...
            <tr><td align="right"><asp:Button ID="Button1" Text="添加" runat="server" OnClick="butAdd_Click" /></td><td></td></tr>
        </table>
            </div>
    </div>
    </form>
