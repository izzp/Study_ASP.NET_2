...
namespace 项目五_使用LINQ实现数据访问
{
    ...
    partial void OntImgChanging(string value);
    partial void OntImgChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_tImg", DbType="VarChar(100)")]
		public string tImg
		{
			get
			{
			...
			set
			{
				if ((this._tImg != value))
				{
					this.OntImgChanging(value);
					this.SendPropertyChanging();
					this._tImg = value;
					this.SendPropertyChanged("tImg");
					this.OntImgChanged();
				}
			}
		}
